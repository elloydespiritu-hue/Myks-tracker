...
export default function App() {
  const { bets, isLoading: isLoadingBets, updatingBetId, syncBets, addBet, updateBetStatus, deleteBet, updateBetDetails, error: betsError } = useBets();
  const { transactions, isLoading: isLoadingTransactions, syncTransactions, addTransaction, error: transactionsError } = useTransactions();
